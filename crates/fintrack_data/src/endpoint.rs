...
impl Endpoints {
    ...
    fn get_fmp_endpoint(&self, key: &str, query: QueryType) -> String {
        ...
        //     QueryType::Info(symbol) => endpoint.get_info(symbol),
        //     QueryType::Quote(symbol) => endpoint.get_quote(symbol),
        //     QueryType::HistoricalData(symbol, start, end) => {
        //         endpoint.get_historical_data(symbol, start, end)
        //     }
        // };
        get_request(&url)
    }
    ...
    fn get_av_endpoint(&self, key: &str, query: QueryType) -> String {
        String::from("AlphaVantage not implemented")
    }
